...
(function () {
  ...
  const TOURS = {
    'neededvault:': [
      ...
      ['#clipAspects', 'Shape of the GIF or MP4', 'Original, 16:9, 4:5, 1:1 or 9:16 — then Frame it to choose what\u2019s in shot.', '#linkInput', 'Once a link or film is playing'],
      ['#exportBtn', 'Save', 'Your stills go into the vault, filed under this project.'],
    ],
    'neededshots:': [
    ...
    'neededgrab:': [
      ...
      ['#clipAspects', 'Shape of the GIF or MP4', 'Original, 16:9, 4:5, 1:1 or 9:16.', '#drop', 'Once a film is in'],
      ['#exportBtn', 'Save', 'Everything files into this project\u2019s grabs.'],
    ],
    'neededcredit:': [
