...
(function () {
  ...
  // ---- The one loading pill for the whole suite: a label, and a percentage
  // when there is one (an animated bar when there isn't).
  ...
  const SLOW = {
    ...
    exportPdf: 'Making the PDF', previewPdf: 'Making the preview', importPdf: 'Reading the PDF', sendMail: 'Sending',
  };
